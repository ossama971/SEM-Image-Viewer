...
void Logger::logMessage(Logger::MessageTypes msgtype,Logger::MessageID msgID,Logger::MessageOptian msgOptians,QVector<QString> args,QString details,QString path) {
...
int Logger::logMessageWithProgressBar(Logger::MessageTypes msgtype,Logger::MessageID msgID,Logger::MessageOptian msgOptians,QVector<QString> args,int itemCount,QString details,QString path){
    int _id = getNextMessageId();
    QString _msgHeader=CreateMessage(msgID,args);
