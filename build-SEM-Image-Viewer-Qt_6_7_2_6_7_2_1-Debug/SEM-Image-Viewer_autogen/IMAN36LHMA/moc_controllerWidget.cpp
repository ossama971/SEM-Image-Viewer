...
#include "../../../SEM-Image-Viewer/widgets/controllerWidget.h"
...
constexpr auto qt_meta_stringdata_CLASSControllerENDCLASS = QtMocHelpers::stringData(
    ...
    "cv::Mat",
    "newImage",
    "onEdgeWidgetFilterApplied",
    "onNoiseReductionFilterApplied",
    "onContourFilterApplied",
    "onGraySacleFilterApplied",
    "redoAction",
    "undoAction"
);
...
Q_CONSTINIT const QMetaObject Controller::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSControllerENDCLASS_t,
        ...
        // method 'onEdgeWidgetFilterApplied'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'onNoiseReductionFilterApplied'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'onContourFilterApplied'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'onGraySacleFilterApplied'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'redoAction'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'undoAction'
...
void Controller::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->imageUpdated((*reinterpret_cast< std::add_pointer_t<cv::Mat>>(_a[1]))); break;
        case 1: _t->onEdgeWidgetFilterApplied(); break;
        case 2: _t->onNoiseReductionFilterApplied(); break;
        case 3: _t->onContourFilterApplied(); break;
        case 4: _t->onGraySacleFilterApplied(); break;
        ...
        {
            using _t = void (Controller::*)(const cv::Mat & );
            if (_t _q_method = &Controller::imageUpdated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Controller::imageUpdated(const cv::Mat & _t1)
{
